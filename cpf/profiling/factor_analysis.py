...
def _main(args=None):
    ...
    # when unpickling.
    import cpf.profiling.factor_analysis
    ...
    subsample = cpf.util.unpickle1(subsample_file)
    print kaiser(subsample.data)
    preprocessor = cpf.profiling.factor_analysis.FactorAnalysisPreprocessor(
    ...
    cpf.util.pickle(output_file, preprocessor)
